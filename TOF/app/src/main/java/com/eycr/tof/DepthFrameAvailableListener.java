...
public class DepthFrameAvailableListener implements ImageReader.OnImageAvailableListener {
    private static final String TAG = com.eycr.tof.DepthFrameAvailableListener.class.getSimpleName();
    ...
    private void processImage(Image image) {
        ...
        noiseReduceMask = com.eycr.tof.FastBlur.boxBlur(noiseReducedMask, WIDTH, HEIGHT, 1);
        ...
        blurredAverage = com.eycr.tof.FastBlur.boxBlur(blurredAverage, WIDTH, HEIGHT, 1);
    }
